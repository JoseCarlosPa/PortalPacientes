...
@section('content')
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('user.index') }}">{{ __('Control de usuarios') }}</a></li>
                        ...
                        <table class="table align-items-center table-flush"  id="datatable-basic">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('Dia de creacion') }}</th>
                                                            ...
                                                            @if ($user->id != auth()->id())
                                                                ...
                                                                @can('delete', $user)
                                                                    <form action="{{ route('user.destroy', $user) }}" method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button type="button" class="dropdown-item" onclick="confirm('{{ __("¿Seguro que quieres eliminar esto?") }}') ? this.parentElement.submit() : ''">
                                                                            {{ __('Eliminar') }}
                                                                        </button>
                                                                    </form>
                                                                @endcan
