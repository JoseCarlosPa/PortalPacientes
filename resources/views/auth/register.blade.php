                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre') }}" type="text" name="name" value="{{ old('nombre') }}" required autofocus>
                                </div>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('user_type') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <select class="form-control{{ $errors->has('user_type') ? ' is-invalid' : '' }}" id="user_type" name="user_type">
                                        <option value="" selected hidden>{{ __('Rol') }}</option>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="{{ __('Confirmar contaseña') }}" type="password" name="password_confirmation" required>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="customCheckRegister">
                                            <span class="text-muted">{{ __('Acepto el') }} <a href="#!">{{ __('Aviso de privacidad') }}</a></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
