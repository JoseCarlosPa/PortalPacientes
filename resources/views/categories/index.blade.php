...
@section('content')
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('category.index') }}">{{ __('Control de categorias') }}</a></li>
                        ...
                        <div class="row align-items-center">
                            ...
                            @if (auth()->user()->can('create', App\Category::class))
                                <div class="col-4 text-right">
                                    <a href="{{ route('category.create') }}" class="btn btn-sm btn-primary">{{ __('Agregar categoria') }}</a>
                                </div>
                            @endif
                        </div>
                    </div>
